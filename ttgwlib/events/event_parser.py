...
MODEL_EVENT_OPCODES = {
    ...
    0xC11C00: model_events.PwmtConfAck,
    0xC21C00: model_events.PwmtStatus,
    0xC31C00: model_events.PwmtVoltages,
    0xC41C00: model_events.PwmtFrequencies,
    0xC51C00: model_events.PwmtVI,
    0xC61C00: model_events.PwmtP,
    0xC71C00: model_events.PwmtQ,
    0xC81C00: model_events.PwmtS,
    0xC91C00: model_events.PwmtPF,
    0xCA1C00: model_events.PwmtE,
    0xCB1C00: model_events.PwmtERet,
    0xC61E00: model_events.OutputCmdAck,
    0xC71E00: model_events.OutputCmdNack,
    0xC81E00: model_events.OutputAck,
    0xCB1E00: model_events.OutputGetRsp,
    0xC02000: model_events.DiagnosisWaketime,
    0xC12000: model_events.DiagnosisUptime,
    0xC22000: model_events.DiagnosisLooptime,
    0xC32000: model_events.DiagnosisRxMsgs,
    0xC42000: model_events.DiagnosisTxMsgs,
    0xC52000: model_events.DiagnosisReboots,
}
    ...
    def stop(self):
        ...
        if self.rx_thread and self.rx_thread.is_alive():
            ...
            if self.rx_thread.is_alive():
                logger.warning("Failed to join RX thread in time")
...
# pylint: disable=bare-except
        try:
            ...
            logger.exception("Error in RX process")
# pylint: enable=bare-except
    ...
    def process_packet(self, msg):
        ...
        try:
            ...
            logger.exception("Parsing error while processing packet")
            raise

...
class TempData(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        ...
        data["temp"] = data_unpacked[0] / 100
        data["hum"] =  data_unpacked[1]
        data["press"] = int.from_bytes(data_unpacked[2], "little") / 10000
...
class PwmtConfAck(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        ...
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        super().__init__(EventType.PWMT_CONF_ACK, data, node, gw)


class PwmtStatus(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<HBBBH", raw_data) # First "HB" is for 3 bytes reserved
        data["n_msgs"] = data_unpacked[2]
        data["status"] = data_unpacked[3]
        data["n_clamps"] = data_unpacked[4]
        data["rssi"] = mesh_data["rssi"]
        data["ttl"] = mesh_data["ttl"]
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        super().__init__(EventType.PWMT_STATUS, data, node, gw)


class PwmtVoltages(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<BHHH", raw_data)
        data["vid"] = (data_unpacked[0]) & 0b11
        data["value_type"] = (data_unpacked[0] >> 2) & 0b11
        data["status"] = (data_unpacked[0] >> 4) & 0b1111
        data["rssi"] = mesh_data["rssi"]
        data["ttl"] = mesh_data["ttl"]
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        data["v1"] = data_unpacked[1] / 100
        data["v2"] = data_unpacked[2] / 100
        data["v3"] = data_unpacked[3] / 100
        super().__init__(EventType.PWMT_VOLTAGES, data, node, gw)


class PwmtFrequencies(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<BHHH", raw_data)
        data["vid"] = (data_unpacked[0]) & 0b11
        ...
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        data["f1"] = data_unpacked[1] / 100
        data["f2"] = data_unpacked[2] / 100
        data["f3"] = data_unpacked[3] / 100
        super().__init__(EventType.PWMT_FREQUENCIES, data, node, gw)


class PwmtVI(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<BBBHH", raw_data)
        data["vid"] = (data_unpacked[0]) & 0b11
        data["value_type"] = (data_unpacked[0] >> 2) & 0b11
        data["status"] = (data_unpacked[0] >> 4) & 0b1111
        data["rssi"] = mesh_data["rssi"]
        ...
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        data["ch_id"] = data_unpacked[2]
        data["v"] = data_unpacked[3] / 100
        data["i"] = data_unpacked[4] / 10
        super().__init__(EventType.PWMT_VI, data, node, gw)


class PwmtP(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<BBBf", raw_data)
        data["vid"] = (data_unpacked[0]) & 0b11
        data["value_type"] = (data_unpacked[0] >> 2) & 0b11
        data["status"] = (data_unpacked[0] >> 4) & 0b1111
        data["rssi"] = mesh_data["rssi"]
        ...
        data["sequence_number"] = mesh_data["sequence_number"]
        data["ch_id"] = data_unpacked[2]
        data["p"] = data_unpacked[3]
        super().__init__(EventType.PWMT_P, data, node, gw)


class PwmtQ(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<BBBf", raw_data)
        data["vid"] = (data_unpacked[0]) & 0b11
        ...
        data["sequence_number"] = mesh_data["sequence_number"]
        data["ch_id"] = data_unpacked[2]
        data["q"] = data_unpacked[3]
        super().__init__(EventType.PWMT_Q, data, node, gw)


class PwmtS(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<BBBf", raw_data)
        data["vid"] = (data_unpacked[0]) & 0b11
        ...
        data["sequence_number"] = mesh_data["sequence_number"]
        data["ch_id"] = data_unpacked[2]
        data["s"] = data_unpacked[3]
        super().__init__(EventType.PWMT_S, data, node, gw)


class PwmtPF(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<BBBf", raw_data)
        data["vid"] = (data_unpacked[0]) & 0b11
        ...
        data["sequence_number"] = mesh_data["sequence_number"]
        data["ch_id"] = data_unpacked[2]
        data["pf"] = data_unpacked[3]
        super().__init__(EventType.PWMT_PF, data, node, gw)


class PwmtE(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<BBBI", raw_data)
        data["vid"] = (data_unpacked[0]) & 0b11
        data["value_type"] = (data_unpacked[0] >> 2) & 0b11
        data["status"] = (data_unpacked[0] >> 4) & 0b1111
        data["rssi"] = mesh_data["rssi"]
        ...
        data["sequence_number"] = mesh_data["sequence_number"]
        data["ch_id"] = data_unpacked[2]
        data["e"] = data_unpacked[3]
        super().__init__(EventType.PWMT_E, data, node, gw)


class PwmtERet(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<BBBI", raw_data)
        data["vid"] = (data_unpacked[0]) & 0b11
        ...
        data["sequence_number"] = mesh_data["sequence_number"]
        data["ch_id"] = data_unpacked[2]
        data["e_ret"] = data_unpacked[3]
        super().__init__(EventType.PWMT_E_RET, data, node, gw)


class OutputGetRsp(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<I", raw_data + b'\x00')[0]
        data["rssi"] = mesh_data["rssi"]
        data["ttl"] = mesh_data["ttl"]
        data["src"] = mesh_data["src"]
        data["dac1"] = {}
        data["dac2"] = {}
        data["relay2"] = (data_unpacked >> 0) & 0x1
        data["relay1"] = (data_unpacked >> 1) & 0x1
        data["dac2_en"] = (data_unpacked >> 2) & 0x1
        data["dac1_en"] = (data_unpacked >> 3) & 0x1
        data["dac2"] = ((data_unpacked >> 4) & 0x3FF) / 1023
        data["dac1"] = ((data_unpacked >> 14) & 0x3FF) / 1023
        data["sequence_number"] = mesh_data["sequence_number"]
        super().__init__(EventType.OUTPUT_GET_RSP, data, node, gw)
...
class PingTimeout(ModelEvent):
    def __init__(self, node, gw):
        data = {}
        super().__init__(EventType.PING_TIMEOUT, data, node, gw)
...
class DiagnosisUptime(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<I", raw_data)
        data["uptime"] = data_unpacked[0]
        data["rssi"] = mesh_data["rssi"]
        data["ttl"] = mesh_data["ttl"]
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        super().__init__(EventType.DIAGNOSIS_UPTIME, data, node, gw)


class DiagnosisLooptime(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<I", raw_data)
        data["looptime"] = data_unpacked[0]
        data["rssi"] = mesh_data["rssi"]
        data["ttl"] = mesh_data["ttl"]
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        super().__init__(EventType.DIAGNOSIS_LOOPTIME, data, node, gw)


class DiagnosisRxMsgs(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<I", raw_data)
        data["rx_msgs"] = data_unpacked[0]
        data["rssi"] = mesh_data["rssi"]
        data["ttl"] = mesh_data["ttl"]
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        super().__init__(EventType.DIAGNOSIS_RX_MSGS, data, node, gw)


class DiagnosisTxMsgs(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<I", raw_data)
        data["tx_msgs"] = data_unpacked[0]
        data["rssi"] = mesh_data["rssi"]
        data["ttl"] = mesh_data["ttl"]
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        super().__init__(EventType.DIAGNOSIS_TX_MSGS, data, node, gw)


class DiagnosisReboots(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<I", raw_data)
        data["n_reboots"] = data_unpacked[0]
        data["rssi"] = mesh_data["rssi"]
        data["ttl"] = mesh_data["ttl"]
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        super().__init__(EventType.DIAGNOSIS_REBOOTS, data, node, gw)


class DiagnosisWaketime(ModelEvent):
    def __init__(self, mesh_data, raw_data, node, gw):
        data = {}
        data_unpacked = struct.unpack("<I", raw_data)
        data["waketime"] = data_unpacked[0]
        data["rssi"] = mesh_data["rssi"]
        data["ttl"] = mesh_data["ttl"]
        data["src"] = mesh_data["src"]
        data["sequence_number"] = mesh_data["sequence_number"]
        super().__init__(EventType.DIAGNOSIS_WAKETIME, data, node, gw)

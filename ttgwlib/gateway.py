...
class Gateway:
    ...
    def set_relay_output(self, node, status):
        ...
        :type status: integer
        """
        self.models.output.set_relay(node, status)

    def set_failsafe_output(self, node, relay, dac):
        ...
        :type relay: integer
        :param dac: Value of the DAC output. 0-1
        :type dac: float
        """
        self.models.output.set_failsafe(node, relay, dac)

    def send_cmd_output(self, node, relay, dac, dt):
        ...
        :type dt: integer
        """
        self.models.output.send_cmd(node, relay, dac, dt)
